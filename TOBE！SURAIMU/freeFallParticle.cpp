...
{
	//加算モードで描画
	Sprite::getInstance()->reserveDraw(texture_, position_, triming_, alpha_, 0.6F, Vector2(1.0F, 1.0F), XMConvertToRadians( rotate_), Vector2(kTextureSize / 2.0F, kTextureSize / 2.0F), Sprite::getInstance()->chengeMode());
}
