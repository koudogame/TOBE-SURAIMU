...
{
	Sprite::getInstance()->reserveDraw( texture_ , position_ + velocity_ , triming_ , 1.0F - now_time_ , 11.0F , Vector2( scale_ , scale_ ) , 0.0F , Vector2( kTextureSize / 2.0F , kTextureSize / 2.0F ) );
}
